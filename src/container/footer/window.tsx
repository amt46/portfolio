...
const WindowFooter = () => {
  const handleClick = (e) => {
    ...
    if (e.target.id === "3") window.open("https://github.com/amt46/portfolio");
  };
  return (
    <motion.div className="flex justify-evenly w-100 p-10 flex-col">
      <motion.div className="fm w-100 flex justify-evenly">
        <motion.div className="mt fw-500">
          ...
          <motion.p className="m-10 flex items-center">& Other</motion.p>
        </motion.div>
      ...
      <motion.div
        whileInView={{ opacity: [0, 1] }}
        transition={{ duration: 0.8 }}
        className="fw-800 text-4xl wr-flex m-20 sm:text-xl text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600"
      >
